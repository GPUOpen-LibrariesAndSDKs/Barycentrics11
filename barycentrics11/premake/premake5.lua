_AMD_SAMPLE_NAME = "Barycentrics11"
...
project (_AMD_SAMPLE_NAME)
   ...
   files { "../src/**.h", "../src/**.cpp", "../src/**.rc", "../src/**.manifest", "../src/**.hlsl", "../../ags_lib/inc/*.h" }
   includedirs { "../src/ResourceFiles", "../../DXUT/Core", "../../DXUT/Optional", "../../ags_lib/inc" }
   libdirs { "../../ags_lib/lib" }
